...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        */
        ...
        //id:costOfServiceEditText olan view komponenti üzerinde klavyeden "enter" girildiğinde setOnKeyListener metodu çalışacak.
        //üzerinde basılacak view referansı ve girilen klavye key'i parametresiyle handleKeyEvent(view, keyCode) metodu çağrılacak.
        binding.costOfServiceEditText.setOnKeyListener { view, keyCode, _ -> handleKeyEvent(view, keyCode) }

    }

    fun calculateTip() {
        val stringInTextField = binding.costOfServiceEditText.text.toString() //id:costOfService olan view componentindeki text özelliğini alır, sitringe çevirip stringInTextField değişkenine atar.
    ...
    private fun handleKeyEvent(view: View, keyCode: Int): Boolean {
        if (keyCode == KeyEvent.KEYCODE_ENTER) { //klavyeden girilen anahtar "enter" ise
            // Hide the keyboard
