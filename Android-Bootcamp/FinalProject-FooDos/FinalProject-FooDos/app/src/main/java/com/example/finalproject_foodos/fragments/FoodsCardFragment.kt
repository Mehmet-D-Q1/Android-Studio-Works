...
import com.example.kisileruygulamasi.viewmodel.CardFoodsVMFactory
...
class FoodsCardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dBinding.recyclerViewCard.setHasFixedSize(true)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tempViewModel: FoodsCardFragmentViewModel by viewModels(){
            CardFoodsVMFactory(requireActivity().application)
        }
